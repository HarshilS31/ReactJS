...
const router = createBrowserRouter(
    createRoutesFromElements(
        ...
        //Loaders are functions that are used to load data before the component is rendered. It takes an object as an argument which contains the params, request and context.
         //another way of defining routes using createRoutesFromElements. 
    )
)
